...
const intro = selected
  ? "Your selected pacing: <strong>1× for all demos except the dashboard at 0.75×</strong>. The new sandbox clip is first. All files are 960 × 600, displayed at <strong>480 × 300</strong>. Generating this preview does not change the README assets."
  : "Both versions contain the same frames: <strong>1× runs for 5 seconds</strong>; <strong>0.75× runs for 6.67 seconds</strong>. Each is shown at <strong>480 × 300</strong>, with 960 × 600 source pixels. Replay a pair to restart them together. Generating this comparison does not change the README GIFs.";
