...
- Explicit deletion removes the review annotation from the UI. Feedback already sent remains in the conversation history. Sent annotations are kept under the initially collapsed **Previous feedback** section, not mixed with active drafts or attached to later sends. Expand it to revisit the original quotation and comment, even after an artifact changes. Updates do not automatically resolve old notes; unfinished and saved unsent drafts remain visible.
